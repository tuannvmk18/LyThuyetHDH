...
var Scheduler = /** @class */ (function () {
    ...
    Scheduler.prototype.SJF = function (Processes) {
        ...
        do {
            ...
            if (((_c = this.currentProcess) === null || _c === void 0 ? void 0 : _c.Tasks[0].Type) == 'CPU') {
            ...
            if (this.currentProcess == undefined) {
                if (this.readyQueue.length != 0) {
                    this.currentProcess = this.readyQueue.shift();
                    (_d = ahihi[count]) === null || _d === void 0 ? void 0 : _d.push(this.currentProcess.ID);
                    (_e = ahihi[count]) === null || _e === void 0 ? void 0 : _e.push(time);
                }
            }
            else {
                ...
                if (((_j = (_h = this.currentProcess) === null || _h === void 0 ? void 0 : _h.Tasks[0]) === null || _j === void 0 ? void 0 : _j.Duration) == 0) {
                    this.currentProcess.Tasks.shift();
                    (_k = ahihi[count]) === null || _k === void 0 ? void 0 : _k.push(time);
                    count++;
                }
                if (this.currentProcess.Tasks.length == 0) {
                    this.currentProcess = undefined;
            ...
            if (((_m = (_l = this.currentProcess) === null || _l === void 0 ? void 0 : _l.Tasks[0]) === null || _m === void 0 ? void 0 : _m.Type) == 'IO') {
                this.IOTask.push({
                    ID: this.currentProcess.ID,
                    Duration: this.currentProcess.Tasks[0].Duration,
                    Type: 'IO',
            ...
            time++;
        } while (this.newQueue.length != 0 || this.readyQueue.length != 0 || this.waitingQueue.length != 0 || ((_o = this.currentProcess) === null || _o === void 0 ? void 0 : _o.Tasks.length) > 0);
        ahihi.sort(function (a, b) {
            if (a[0] < b[0])
                return -1;
            else if (a[0] > b[0])
